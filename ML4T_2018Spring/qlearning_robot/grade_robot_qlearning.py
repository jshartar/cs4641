...
def test_qlearning(description, group, world_file, best_reward, median_reward, max_time, points):
    ...
    try:
        ...
        if group=='nodyna':
            ...
            student_reward = timeoutwrapper_nodyna()
            incorrect = False
            ...
            student_reward = timeoutwrapper_dyna()
            incorrect = False
            if student_reward < 1.5*median_reward:
                incorrect = True
                msgs.append("   Reward too low, expected %s, found %s"%(median_reward,student_reward))
            ...
            student_author = timeoutwrapper_author()
